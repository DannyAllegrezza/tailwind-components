...
export default function Page() {
  ...
  return (
    <div className="flex h-screen w-screen">
      <div className="hidden w-64 flex-shrink-0 bg-layer-2 md:block">
        {sidebarElement}
      </div>
      ...
      <div className="relative w-full flex-1">
        ...
        <div className="mx-auto mt-10 w-8/12">
          <header>
            <h1 className="text-3xl font-semibold text-heading">Page Title</h1>
          </header>
          <main className="mt-10">
            {/* Replace content here */}
            <div className="h-96 rounded-xl border-4 border-dashed border-muted-1"></div>
          </main>
        </div>
      </div>
    </div>
