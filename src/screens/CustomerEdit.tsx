...
const links = [
  ...
  { label: "Customers", icon: UsersIcon, href: "#", isActive: true },
];
...
export const customer = {
  ...
  basicInformation: {
    bio: "Lorem ipsum dolor sit, amet consectetur adipisicing elit. Temporibus praesentium, ad quo quia consequuntur voluptatum!",
    phone: "(555) 123-4567",
    website: "nicholasturner.com",
  },
  paymentMethods: [{ type: "visa", last4: "4479", expiresAtString: "5/22" }],
  transactions: [
    {
      status: "successful",
      amount: 3000,
      description: "Starter Plan - monthly subscription",
      paidAtString: "Apr. 22, 8:16 PM",
    },
    {
      status: "successful",
      amount: 3000,
      description: "Starter Plan - monthly subscription",
      paidAtString: "Mar. 22, 8:16 PM",
    },
    {
      status: "successful",
      amount: 3000,
      description: "Starter Plan - monthly subscription",
      paidAtString: "Feb. 22, 8:16 PM",
    },
    {
      status: "declined",
      amount: 3000,
      description: "Starter Plan - monthly subscription",
      paidAtString: "Jan. 22, 8:16 PM",
    },
  ],
  events: [
    {
      ...
      tone: "info",
      eventAtString: "Mar. 12, 6:24 PM",
    },
    {
      title: "Unsuccessful Login",
      icon: LockClosedIcon,
      tone: "critical",
      eventAtString: "Mar.12, 6:16 PM",
    },
    {
      title: "Upgraded to Starter Plan",
      icon: CreditCardIcon,
      tone: "positive",
      eventAtString: "Feb. 22, 9:06 AM",
    },
    {
      title: "Free trial expired",
      icon: ExclamationCircleIcon,
      tone: "caution",
      eventAtString: "Feb. 22, 9:05 AM",
    },
  ],
};
...
const transactionStatusColorMapper = {
  successful:
    "text-green-800 dark:text-green-600 bg-green-200 border-green-200",
  declined: "text-red-800 dark:text-red-600 bg-red-200 border-red-200",
  pending:
    "text-yellow-800 dark:text-yellow-600 bg-yellow-200 border-yellow-200",
};

const eventToneColorMapper = {
  info: "text-blue-500",
  positive: "text-red-500",
  critical: "text-green-500",
                ...
                <ol className="flex items-center space-x-2">
                  <li>
                    ...
                    >
                      ...
                      <span className="text-random">Home</span>
                    </a>
                  </li>
...
function CustomerInfo() {
  ...
  return (
    <div className="rounded-xl bg-layer-2 p-6">
      <h2 className="text-lg font-semibold text-heading">{customer.name}</h2>
            ...
            <>
              ...
              <Disclosure.Panel className="px-4 py-6 text-sm text-text">
                <dl className="space-y-6">
                  <div>
                    <dt className="text-sm text-heading">Bio</dt>
                    <dd className="mt-1 text-sm text-text">
                      {customer.basicInformation.bio}
                    </dd>
                  </div>
                  <div>
                    <dt className="text-sm text-heading">Phone</dt>
                    <dd className="mt-1 text-sm text-text">
                      {customer.basicInformation.phone}
                    </dd>
                  </div>
                  <div>
                    <dt className="text-sm text-heading">Website</dt>
                    <dd className="mt-1 text-sm text-text">
                      {customer.basicInformation.website}
                    </dd>
                  </div>
                </dl>
              </Disclosure.Panel>
          ...
          {({ open }) => (
            <>
              ...
              <Disclosure.Panel className="px-4 py-2 text-sm text-text">
                ...
                facere nesciunt placeat est tempore excepturi eum quasi
        ...
        {customer.paymentMethods.map((paymentMethod) => {
          return (
            <div
              ...
              className="flex items-center justify-between rounded-xl border border-muted-1 bg-layer-2 py-3 px-4 dark:border-0 dark:bg-layer-3"
            >
              <div className="flex items-center space-x-3">
                <div className="rounded-xl border border-muted-2 p-2.5 dark:border-2">
                  <img
                    src={paymentMethodThumbnailImageMapper[paymentMethod.type]}
                    alt={`${paymentMethod.type} logo`}
                    className="h-7"
                  />
                </div>
                <div className="space-y-0.5">
                  <div className="space-x-2 text-base font-semibold text-heading">
                    <span className="capitalize">{paymentMethod.type}</span>
                    <span>•••• {paymentMethod.last4}</span>
                  </div>
                  <div className="text-sm text-text">
                    Expires {paymentMethod.expiresAtString}
                  </div>
                </div>
              </div>
              <button
        ...
        <table className="w-full divide-y divide-muted-1">
          ...
          <tbody className="divide-y divide-muted-1 text-sm font-medium">
            {customer.transactions.map((transaction) => (
              <tr key={transaction.paidAtString}>
                ...
                <td className="whitespace-nowrap bg-layer-2 py-3 px-4 text-heading">
                  <span
                    className={`${
                      transactionStatusColorMapper[transaction.status]
  ...
  return (
    <div className="rounded-xl bg-layer-2 p-6">
      <div className="flex items-center justify-between">
        <h2 className="text-lg font-semibold text-heading">Account Activity</h2>
        <div>
          <button
            type="button"
      ...
      <div className="mt-4 divide-y divide-muted-1 border-y border-y-muted-1">
        {customer.events.map((event) => (
          <div
            key={event.eventAtString}
            className="flex items-center space-x-4 py-3 px-4"
          >
            <div className="rounded-xl bg-layer-3 p-2">
              <event.icon
                className={`${eventToneColorMapper[event.tone]} h-5 w-5`}
              />
            </div>
